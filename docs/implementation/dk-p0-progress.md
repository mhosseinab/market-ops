...
| S6 | CI pipeline | in_progress | 1 | (worker worktree) | — | dispatched (reliability-delivery). ci.yml can't run here → Verify=ci:local+actionlint; first-GitHub-run deferred gate |
