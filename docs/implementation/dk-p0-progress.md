...
| S5 | DB foundation (goose+sqlc+River) | in_progress | 1 | worktree-agent-a100671f (2fb7ee7) | 2fb7ee7 | worker green (reset-first worked): goose 0001 (3 base tables, down proven), sqlc pgx/v5, River EnqueueTx+heartbeat+rollback-discard test — all 4 Verify pass vs native PG16.13. In review. Merge note: edits services/core/go.mod (river/pgx) + Taskfile.yml (db:reset+doctor river) + monorepo doc → resolve go.mod/doc overlap w/ S4 at merge |
