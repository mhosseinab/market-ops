...
| S4 | Contracts pipeline + drift check [C] | in_progress | 1 | dk-p0/S4 | — | dispatched (contract-data). Serialized vs S7 (both edit .golangci.yml) |
