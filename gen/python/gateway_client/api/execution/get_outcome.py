...
def _parse_response(*, client: Client, response: httpx.Response) -> ErrorEnvelope | OutcomeView:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ErrorEnvelope | OutcomeView]:
    return Response(
