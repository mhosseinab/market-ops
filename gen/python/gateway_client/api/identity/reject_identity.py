...
def sync_detailed(
    *,
    ...
    """Reject a Needs Review candidate.
     ...
     Transitions a NeedsReview candidate to Rejected (journey 4 step 2). A rejected mapping never feeds
    an executable path and frees the variant for a fresh candidate later. The decision is recorded in an
    append-only audit.
