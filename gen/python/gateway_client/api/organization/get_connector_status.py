...
def sync_detailed(
    *,
    ...
    """Inspect connection and per-capability status.
     ...
     Returns the current connection state plus every §15.2 capability with its status and last-verified
    time. Capabilities default to Unknown and never enable dependent UI while Unknown (ACC-001).
