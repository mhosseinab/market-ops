...
def sync_detailed(
    *,
    ...
    """Refresh the DK access token and re-run capability probes.
     ...
     Rotates the access token via the stored refresh token (re-encrypted at rest) and re-probes every
    capability so status and last-verified time stay current (ACC-001, ACC-003).
