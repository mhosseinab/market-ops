...
def _parse_response(*, client: Client, response: httpx.Response) -> ErrorEnvelope | OperationsQueues:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ErrorEnvelope | OperationsQueues]:
    return Response(
