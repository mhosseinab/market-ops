...
def sync_detailed(
    *,
    ...
    """Return the identity of the current session.
     ...
     Returns the user, organization, role, and expiry of the session bound to the request cookie.
    Requires a valid session; fails closed with 401 when the cookie is absent, unknown, or expired.
