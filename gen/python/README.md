# gen-python
A client library for accessing Market-Ops Gateway API
...
```python
from gateway_client import AuthenticatedClient
...
```python
from gateway_client.models import MyDataModel
from gateway_client.api.my_tag import get_my_data_model
from gateway_client.types import Response
...
1. Any endpoint which did not have a tag will be in `gateway_client.api.default`
